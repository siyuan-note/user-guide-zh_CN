思源笔记的编辑器组件叫做“Vditor”，它是一款浏览器端的编辑器，也是由我们设计和开发的开源项目，可以在[这里](https://github.com/Vanessa219/vditor)找到它的代码。我们基于 Vditor 开发了现在思源笔记中使用的编辑器，未来将继续进行完善，给大家带来更现代化的编辑体验。
