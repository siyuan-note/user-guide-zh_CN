## 概述
{: id="20210111224435-y1fesd1" updated="20210512154656"}
...
{: id="20201224120447-1ros46z" updated="20210512154659"}
...
!{{SELECT * FROM blocks WHERE content LIKE '%在思源中%' AND content LIKE '%核心概念%' AND path NOT LIKE '%嵌入内容块%'}}
...
!{{SELECT * FROM blocks WHERE (content LIKE '%#内容块/嵌入#%' OR content LIKE '%#内容块/引用#%') AND path NOT LIKE '%嵌入内容块%'}}
