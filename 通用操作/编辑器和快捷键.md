...
| 移除光标所在元素                      | <kbd>Ctrl+Shift+X</kbd> / <kbd>⇧⌘X</kbd>                          | 快速移除内容用块引用/内容块嵌入/内容块动态查询/块/链接/图片 |
| 复制/复制块引用                        | <kbd>Ctrl+C</kbd> / <kbd>⌘C</kbd>                                   | 没有选择内容时为复制块引用                                                |
| 复制块内容                               | <kbd>Ctrl+Shift+C</kbd> / <kbd>⇧⌘C</kbd>                          |                                                                                        |
