...
## 编辑模式
{: id="20210115220400-onc62dm"}

我们可以通过如下三种编辑模式来修改文档内容，编辑能力由弱到强：
{: id="20210115220503-vekir4u"}

* {: id="20210115220412-x7yg3z4"}脑图模式：可通过在文件树上右键文档下拉菜单进入，仅支持基本的创建、移动，主要用于整理思路，快速创建和浏览文档大纲
* {: id="20210115220745-0wg7d4s"}即时渲染模式：打开文档时默认使用该模式，可使用 Markdown 语法进行文档编辑排版
* {: id="20210115221228-g3fjsj7"}专家模式：可通过在文件树上右键文档下拉菜单进入，以 Markdown 源码的方式进行文档编辑排版 #TODO#
...
| 复制标准 Markdown                         | <kbd>Ctrl+Alt+C</kbd> / <kbd>⌥⌘C</kbd>                            |                                                                                  |
