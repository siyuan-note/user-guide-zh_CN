...
| 全局搜索                       | <kbd>Ctrl+F</kbd> / <kbd>⌘F</kbd> / <kbd>Click+标签</kbd>                                        |                                                    |
...
| 复制该块为引用块                     | <kbd>Ctrl+Shift+C</kbd> / <kbd>⇧⌘C</kbd>                        |                                                    |
| 粘贴            | <kbd>Ctrl+V</kbd> / <kbd>⌘V</kbd>                                |  可将选中内容作为链接标题或块引用锚点                 |
| 粘贴为纯文本        | <kbd>Ctrl+Shift+V</kbd> / <kbd>⇧⌘V</kbd>                        |  仅桌面端可用              |
...
| 重命名                         | <kbd>F2</kbd>                                 |                                                    |
| 使用选中内容作为新建文档的名称 | <kbd>F3</kbd>                                  |                                                    |
| 使用选中内容作为新建文档的内容 | <kbd>F4</kbd>                                  |                                                    |
...
| 引用块                     | <kbd>((</kbd> / <kbd>[[</kbd> / <kbd>（（</kbd> / <kbd>【【</kbd> |                                                    |
| 唤起功能菜单                  | <kbd>/</kbd>                                                     |                                                    |
...
| 移动               | 拖拽     |
| 打开菜单             | 点击     |
| 进入             |  <kbd>Ctrl+Click</kbd> / <kbd>⌘Click</kbd>     |
| 折叠/展开                    | <kbd>Alt+Click</kbd> / <kbd>⌥Click</kbd>     |
| 命名 | <kbd>Shift+Click</kbd> / <kbd>⇧Click</kbd> |
...
| -------------- | --------------------------------------------------- | -------------------- |
| 表情         | <kbd>:</kbd>                                      |                    |
| 引用块       | <kbd>Ctrl+[</kbd> / <kbd>⌘[</kbd>                 |     需选中内容               |
...
| 字体设置     | <kbd>Alt+X</kbd> / <kbd>⌥X</kbd>                 |   将选中内容设置为最近一次使用过的字体样式                 |
| 分割线       | <kbd>---</kbd>                |                   |
...
| 任务列表     | <kbd>Ctrl+L</kbd> / <kbd>⌘L</kbd>        | 相关快捷键参见下文 |
...
| 完成和待办之间切换 | <kbd>Ctrl+;</kbd> / <kbd>⌘;</kbd> / <kbd>></kbd>| 任务列表 |
...
| 删除列                 | <kbd>Ctrl+Shift+_</kbd> / <kbd>⇧⌘_</kbd>   |
